...
//If they entered continue looking for that years best seller
if($_POST['year']!='')
{//Code to grab best seller of a given year
$q2 = "select * from book where book_id in 
(select b.book from 
...
as s group by s.years) as b where b.years ='$year_provided')";
$result = mysqli_query($myconnection, $q2);

//If no rows return best seller of all years
...
//else show best seller of input year
else
{
echo "<form method = 'post' action = 'cart.php' >";
echo "<table>";
...
//else return best seller of all years
else{
//else defaults to show best sellers of every year
$q1 = "select * from book where book_id in 
(select b.book from 
